...
7. **Telemetry and operations are L5+ opt-in agents.** They are absent from L1–L4. At L5–L6 they use a paused cadence in every governor mode and may open issues and PRs, but never merge.
