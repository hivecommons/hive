...
- **Jira holds** use exact, case-sensitive equality against configured `work_source.jira.hold_labels`; there is no built-in Jira default (`src/pkg/worksource/jira.go:24-35`, `src/pkg/worksource/jira.go:144-168`).
