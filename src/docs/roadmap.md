...
| Hosted Hive Hub positioning | Anchor the hosted hub (hive.hivecommons.dev) as a named workstream: document tenancy limits, data-retention and account expectations, the hosted-vs-self-hosted decision, and which v5 fleet workstreams the hosted fleet exercises first. | [#6017](https://github.com/hivecommons/hive/issues/6017), [ROADMAP.md](../../ROADMAP.md#hosted-hive-hub) |
