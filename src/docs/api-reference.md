...
| `GET` | `/api/classifier/stats` | Dashboard auth/session | Jev classifier agreement, fallback, estimated input token, and estimated spend counters | `pkg/dashboard/server.go:1178` |
