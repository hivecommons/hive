...
| File | Use Case |
|------|----------|
| `deploy/hive-quickstart.yaml` | Quick-start evaluation roster targeting `hivecommons/hive-tester` with all ten built-in agent lanes enabled under `acmm_level: 1` |
