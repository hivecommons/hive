...
func TestBobConstants(t *testing.T) {
	tests := []struct {
		...
		{"bob v2 shell settings key", BobV2ShellKey, "bobShell"},
		{"bob v2 auto-update key", BobV2AutoUpdateKey, "autoUpdate"},
		{"bob legacy general key", BobLegacyGeneralKey, "general"},
		{"bob legacy disable auto-update key", BobLegacyDisableAutoUpdateKey, "disableAutoUpdate"},
		{"bob legacy disable update nag key", BobLegacyDisableUpdateNagKey, "disableUpdateNag"},
