...
// Sandbox wiring for pkg/agent — the sandboxed-kick execution path and the
// setters the hub uses to inject its launcher, minters, PR client and audit
// sink. Split verbatim out of manager.go (#7303); the sandbox executor itself
// lives in sandbox_executor.go.
