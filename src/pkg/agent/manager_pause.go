...
// Pause/resume and fleet-breaker control for pkg/agent — the pause transition
// observers, the per-agent pause and resume paths, and the breaker that pauses
// and releases the whole fleet at once. Split verbatim out of manager.go
// (#7303).
