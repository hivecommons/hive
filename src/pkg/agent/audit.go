...
// policy-layer packages (pkg/toolapprove, pkg/turn) can emit audit events
// without importing this runtime package. The aliases below keep every
// existing consumer of agent.Audit* / agent.AuditSink / agent.FormatAuditDetail
// working unchanged.
const (
