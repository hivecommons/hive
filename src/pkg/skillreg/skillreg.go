...
// "skills". It extends the agentsmd package, which parses skills inline in a
// single AGENTS.md, into a reusable registry so skills can be named, versioned,
// and resolved across repos and agents — the seed of a community catalog.
//
...
// It remains a standalone helper so any future caller can render the same block.
