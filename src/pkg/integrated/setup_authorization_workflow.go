...
`
	replacer := strings.NewReplacer(
		...
		"__WRITER_ID__", strconv.FormatInt(effectiveVisualHiveGitHubWriter(config).ID, 10),
		"__WRITER_LOGIN__", strings.ToLower(effectiveVisualHiveGitHubWriter(config).Login),
		"__WRITER_TYPE__", strings.ToLower(effectiveVisualHiveGitHubWriter(config).Type),
