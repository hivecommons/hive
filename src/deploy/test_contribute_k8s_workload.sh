...
contains "limits memory to the shared ceiling" "$OUT" "memory: \"4Gi\""
contains "requests half a CPU"                 "$OUT" "cpu: \"500m\""
contains "limits CPU to the shared ceiling"    "$OUT" "cpu: \"2\""
