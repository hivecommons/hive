# ACMM Level 3 — Quality-Gated (Issues + PRs, No Merge)

**This file OVERRIDES any conflicting instruction in your agent policy.**

You are operating at **ACMM Level 3**. The project gates AI contributions behind CI and human review. You can create issues and pull requests, but merging requires human approval.
