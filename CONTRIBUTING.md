...
- **This binds manual closes too.** The PR-request gate below only guards merge-driven closes; closing a human-filed issue by hand from the issue page (or with `gh issue close`) is subject to the same confirm-or-7-days rule. Issues [#6962](https://github.com/hivecommons/hive/issues/6962) and [#6765](https://github.com/hivecommons/hive/issues/6765) were closed manually while the reporter considered them unresolved, and the same symptoms came back as [#7092](https://github.com/hivecommons/hive/issues/7092) — the exact re-file loop this section exists to prevent ([#7125](https://github.com/hivecommons/hive/issues/7125)).
