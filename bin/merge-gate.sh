...
AI_AUTHORS = {os.environ.get('PROJECT_AI_AUTHOR', ''), 'copilot-swe-agent[bot]', 'github-actions[bot]', 'dependabot[bot]', 'app/hivecommons-hive', 'app/kubestellar-hive', 'hivecommons-hive[bot]', 'kubestellar-hive[bot]'} - {''}
