...
| [Project Bluefin](https://github.com/projectbluefin) | Self-managed hive over `projectbluefin/knuckle` and related repos, running at a measured ACMM level | Production | Named production adopter in the [general technical review](src/docs/general-technical-review.md) and [CNCF reference architecture](src/docs/cncf-reference-architecture.md); operational feedback in [#4928](https://github.com/hivecommons/hive/issues/4928), [#6449](https://github.com/hivecommons/hive/issues/6449), [#6450](https://github.com/hivecommons/hive/issues/6450) |
